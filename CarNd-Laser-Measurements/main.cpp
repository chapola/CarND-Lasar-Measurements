...
int main() {
    ...
    string in_file_name_ = "/Users/bajrangchapola/Dev/xcode/CarNd-Laser-Measurements/data/obj_pose-laser-radar-synthetic-input.txt";
    ...
    while(getline(in_file, line) && (i<=3)){
        ...
        if(sensor_type.compare("L") == 0){    //laser measurement
            //read measurements
            meas_package.sensor_type_ = MeasurementPackage::LASAR;
